...
ActiveRecord::Schema.define(version: 20170301030709) do
  ...
  create_table "class_names", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_class_names_on_name", unique: true, using: :btree
  end
  ...
  create_table "students", force: :cascade do |t|
    ...
    t.datetime "updated_at",             null: false
    t.integer  "class_id"
    t.index ["class_id"], name: "index_students_on_class_id", using: :btree
  end
